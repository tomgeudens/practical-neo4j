...
@Configuration
public interface ExamplePregelComputationConfiguration extends PregelProcedureConfig {
    static ExamplePregelComputationConfiguration of(
            String username,
        ...
        return new ExamplePregelComputationConfigurationImpl(graphName, maybeImplicitCreate, username, userInput);
    }
}
