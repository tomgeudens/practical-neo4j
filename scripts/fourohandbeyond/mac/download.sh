...
curl -L -o "install/zulu${zuluVersion}-ca-jre${jreVersion}-macosx_x64.tar.gz" https://cdn.azul.com/zulu/bin/zulu${zuluVersion}-ca-jre${jreVersion}-macosx_x64.tar.gz
