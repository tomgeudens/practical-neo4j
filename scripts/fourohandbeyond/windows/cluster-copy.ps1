...
$configLines = (
    ...
    "causal_clustering.discovery_listen_address=127.0.0.1:$discovery",
    "causal_clustering.transaction_listen_address=127.0.0.1:$transaction",
    "causal_clustering.raft_listen_address=127.0.0.1:$raft",
    ...
    "dbms.connector.bolt.advertised_address=127.0.0.1:$bolt",
    "dbms.connector.bolt.listen_address=127.0.0.1:$bolt",
    "dbms.connector.http.enabled=true",
    "dbms.connector.http.listen_address=127.0.0.1:$http",
    "dbms.connector.http.advertised_address=127.0.0.1:$http",
    "dbms.connector.https.enabled=false",
    "dbms.connector.https.listen_address=127.0.0.1:$https",
    "dbms.connector.https.advertised_address=127.0.0.1:$https",
    "",
